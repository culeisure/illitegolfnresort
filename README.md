...
| 문자 상담 (섹션·하단바) | `010-4087-3443` (본문 자동: "상담 요청드립니다.") |
...
| 창립 혜택 마감일 | `script.js` 상단 `DL_Y / DL_M / DL_D` (`DL_M`은 0-인덱스, 6월=5). 본문 노출 문구는 `index.html`의 "6월 30일" 3곳 (헤더 띠 / CTA 박스 / 푸터). 마감 다음 날부터 D-day 띠·박스 자동 숨김 |
